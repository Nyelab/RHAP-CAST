...
# forecast for 03-07-2026 to 03-13-2026 ----
## forecast on 03-02-2026
## hindcast on 03-02 2006-2026

## ECMWF Real time ----
### perturbed with 100 members

# 03-07-2026
ECMWF_rt  <- rast("ECMWF_0307_rt.grib")
shape_rt <- st_transform(shape, crs(ECMWF_rt))
cropped_rt <- crop(ECMWF_rt, shape_rt)
masked_rt <- mask(cropped_rt, shape_rt)
...
rt_0307 <- rt %>% filter(forecast_time %in% c("2026-03-07"))


rt_mean07 <- rt_0307 %>% group_by(longitude, latitude) %>%
  summarise(temp_K = mean(temp_K))
...
# 03-08-2026
ECMWF_rt  <- rast("ECMWF_0308_rt.grib")
shape_rt <- st_transform(shape, crs(ECMWF_rt))
cropped_rt <- crop(ECMWF_rt, shape_rt)
masked_rt <- mask(cropped_rt, shape_rt)
...
rt_0308 <- rt %>% filter(forecast_time %in% c("2026-03-08"))


rt_mean08 <- rt_0308 %>% group_by(longitude, latitude) %>%
  summarise(temp_K = mean(temp_K))
...
# 03-09-2026
ECMWF_rt  <- rast("ECMWF_0309_rt.grib")
shape_rt <- st_transform(shape, crs(ECMWF_rt))
cropped_rt <- crop(ECMWF_rt, shape_rt)
masked_rt <- mask(cropped_rt, shape_rt)
...
rt_0309 <- rt %>% filter(forecast_time %in% c("2026-03-09"))


rt_mean09 <- rt_0309 %>% group_by(longitude, latitude) %>%
  summarise(temp_K = mean(temp_K))
...
# 03-10-2026
ECMWF_rt  <- rast("ECMWF_0310_rt.grib")
shape_rt <- st_transform(shape, crs(ECMWF_rt))
cropped_rt <- crop(ECMWF_rt, shape_rt)
masked_rt <- mask(cropped_rt, shape_rt)
...
rt_0310 <- rt %>% filter(forecast_time %in% c("2026-03-10"))


rt_mean10 <- rt_0310 %>% group_by(longitude, latitude) %>%
  summarise(temp_K = mean(temp_K))
...
# 03-11-2026
ECMWF_rt  <- rast("ECMWF_0311_rt.grib")
shape_rt <- st_transform(shape, crs(ECMWF_rt))
cropped_rt <- crop(ECMWF_rt, shape_rt)
masked_rt <- mask(cropped_rt, shape_rt)
...
rt_0311 <- rt %>% filter(forecast_time %in% c("2026-03-11"))


rt_mean11 <- rt_0311 %>% group_by(longitude, latitude) %>%
  summarise(temp_K = mean(temp_K))
...
# 03-12-2026
ECMWF_rt  <- rast("ECMWF_0312_rt.grib")
shape_rt <- st_transform(shape, crs(ECMWF_rt))
cropped_rt <- crop(ECMWF_rt, shape_rt)
masked_rt <- mask(cropped_rt, shape_rt)
...
rt_0312 <- rt %>% filter(forecast_time %in% c("2026-03-12"))


rt_mean12 <- rt_0312 %>% group_by(longitude, latitude) %>%
  summarise(temp_K = mean(temp_K))
...
# 03-13-2026
ECMWF_rt  <- rast("ECMWF_0313_rt.grib")
shape_rt <- st_transform(shape, crs(ECMWF_rt))
cropped_rt <- crop(ECMWF_rt, shape_rt)
masked_rt <- mask(cropped_rt, shape_rt)
...
rt_0313 <- rt %>% filter(forecast_time %in% c("2026-03-13"))


rt_mean13 <- rt_0313 %>% group_by(longitude, latitude) %>%
  summarise(temp_K = mean(temp_K))
...
ECMWF_hc<- rast("ECMWF_0307_0313_hc.grib")
...
all_dates <- do.call(
  ...
  lapply(years, function(y) {
    dates <- seq(
      from = as.Date(sprintf("%d-03-07", y)),
      to   = as.Date(sprintf("%d-03-13", y)),
      by = "day"
    )
...
SST_0307_0313 <- SST_mar %>% filter(day %in% c(07:13))


SST_0307 <- SST_0307_0313 %>% group_by(longitude, latitude) %>%
  summarise(temp_C = mean(temp_C))
...
ECMWF_df$date <- as.Date("2026-03-07")
...
library(htmlwidgets)
saveWidget(AM_plot, file = "AM_0307_0313_map.html", selfcontained = TRUE)
...
library(htmlwidgets)
saveWidget(AH_plot, file = "AH_0307_0313_map.html", selfcontained = TRUE)
...
library(htmlwidgets)
saveWidget(RH_plot, file = "RH_0307_0313_map.html", selfcontained = TRUE)
...
AHRH1 <- ggplot(AHRH_poly) +
  ...
  theme_classic() +
  labs(fill = "Probability", color = "Presence") +
  ggtitle("March 7, 2026 to March 13, 2026: Atlantic Herring * (1-River Herring)") +
  coord_sf(crs = 32619) +
  annotation_north_arrow(location = "tl",
                         which_north = "true",
                         style = north_arrow_fancy_orienteering) +
...
library(htmlwidgets)
saveWidget(AHRH, file = "AHRH_0307_0313_map.html", selfcontained = TRUE)
...
AMRH1 <- ggplot(AMRH_poly) +
  ...
  theme_classic() +
  labs(fill = "Probability", color = "Presence") +
  ggtitle("March 7, 2026 to March 13, 2026: Atlantic Mackerel * (1-River Herring)") +
  coord_sf(crs = 32619) +
  annotation_north_arrow(location = "tl",
                         which_north = "true",
                         style = north_arrow_fancy_orienteering) +
...
library(htmlwidgets)
saveWidget(AMRH, file = "AMRH_0307_0313_map.html", selfcontained = TRUE)
...
pdf("forecast_0307_0313.pdf", width = 8, height = 6)
...
AM1_ci <- ggplot() +
  ...
  coord_sf(crs = 32619) +
  labs(fill = "CI width", color = "Presence") +
  ggtitle("March 7 - March 13: Atlantic Mackerel") 
#theme(legend.position = "none") +
# annotation_north_arrow(location = "tl",
#                        which_north = "true",
#                        style = north_arrow_fancy_orienteering) +
...
AH1_ci <- ggplot() +
  ...
  coord_sf(crs = 32619) +
  labs(fill = "CI width", color = "Presence") +
  ggtitle("March 7 - March 13: Atlantic Herring") 
...
RH1_ci <- ggplot() +
  ...
  coord_sf(crs = 32619) +
  labs(fill = "CI width", color = "Presence") +
  ggtitle("March 7 - March 13: River Herring") 
...
pdf("forecast_0307_0313_uncertainty.pdf", width = 8, height = 6)
...
# forecast for 03-14-2026 to 03-20-2026 ----
## forecast on 03-09-2026
## hindcast on 03-09 2006-2026

## ECMWF Real time ----
### perturbed with 100 members

# 03-14-2026
ECMWF_rt  <- rast("ECMWF_0314_rt.grib")
shape_rt <- st_transform(shape, crs(ECMWF_rt))
cropped_rt <- crop(ECMWF_rt, shape_rt)
masked_rt <- mask(cropped_rt, shape_rt)
...
rt_0314 <- rt %>% filter(forecast_time %in% c("2026-03-14"))


rt_mean14 <- rt_0314 %>% group_by(longitude, latitude) %>%
  summarise(temp_K = mean(temp_K))
...
# 03-15-2026
ECMWF_rt  <- rast("ECMWF_0315_rt.grib")
shape_rt <- st_transform(shape, crs(ECMWF_rt))
cropped_rt <- crop(ECMWF_rt, shape_rt)
masked_rt <- mask(cropped_rt, shape_rt)
...
rt_0315 <- rt %>% filter(forecast_time %in% c("2026-03-15"))


rt_mean15 <- rt_0315 %>% group_by(longitude, latitude) %>%
  summarise(temp_K = mean(temp_K))
...
# 03-16-2026
ECMWF_rt  <- rast("ECMWF_0316_rt.grib")
shape_rt <- st_transform(shape, crs(ECMWF_rt))
cropped_rt <- crop(ECMWF_rt, shape_rt)
masked_rt <- mask(cropped_rt, shape_rt)
...
rt_0316 <- rt %>% filter(forecast_time %in% c("2026-03-16"))


rt_mean16 <- rt_0316 %>% group_by(longitude, latitude) %>%
  summarise(temp_K = mean(temp_K))
...
# 03-17-2026
ECMWF_rt  <- rast("ECMWF_0317_rt.grib")
shape_rt <- st_transform(shape, crs(ECMWF_rt))
cropped_rt <- crop(ECMWF_rt, shape_rt)
masked_rt <- mask(cropped_rt, shape_rt)
...
rt_0317 <- rt %>% filter(forecast_time %in% c("2026-03-17"))


rt_mean17 <- rt_0317 %>% group_by(longitude, latitude) %>%
  summarise(temp_K = mean(temp_K))
...
# 03-18-2026
ECMWF_rt  <- rast("ECMWF_0318_rt.grib")
shape_rt <- st_transform(shape, crs(ECMWF_rt))
cropped_rt <- crop(ECMWF_rt, shape_rt)
masked_rt <- mask(cropped_rt, shape_rt)
...
rt_0318 <- rt %>% filter(forecast_time %in% c("2026-03-18"))


rt_mean18 <- rt_0318 %>% group_by(longitude, latitude) %>%
  summarise(temp_K = mean(temp_K))
...
# 03-19-2026
ECMWF_rt  <- rast("ECMWF_0319_rt.grib")
shape_rt <- st_transform(shape, crs(ECMWF_rt))
cropped_rt <- crop(ECMWF_rt, shape_rt)
masked_rt <- mask(cropped_rt, shape_rt)
...
rt_0319 <- rt %>% filter(forecast_time %in% c("2026-03-19"))


rt_mean19 <- rt_0319 %>% group_by(longitude, latitude) %>%
  summarise(temp_K = mean(temp_K))
...
# 03-20-2026
ECMWF_rt  <- rast("ECMWF_0320_rt.grib")
shape_rt <- st_transform(shape, crs(ECMWF_rt))
cropped_rt <- crop(ECMWF_rt, shape_rt)
masked_rt <- mask(cropped_rt, shape_rt)
...
rt_0320 <- rt %>% filter(forecast_time %in% c("2026-03-20"))


rt_mean20 <- rt_0320 %>% group_by(longitude, latitude) %>%
  summarise(temp_K = mean(temp_K))
...
ECMWF_hc<- rast("ECMWF_0314_0320_hc.grib")
...
all_dates <- do.call(
  ...
  lapply(years, function(y) {
    dates <- seq(
      from = as.Date(sprintf("%d-03-14", y)),
      to   = as.Date(sprintf("%d-03-20", y)),
      by = "day"
    )
...
SST_0314_0320 <- SST_mar %>% filter(day %in% c(14:20))


SST_0314 <- SST_0314_0320 %>% group_by(longitude, latitude) %>%
  summarise(temp_C = mean(temp_C))
...
ECMWF_df$date <- as.Date("2026-03-14")
...
library(htmlwidgets)
saveWidget(AM_plot, file = "AM_0314_0320_map.html", selfcontained = TRUE)
...
library(htmlwidgets)
saveWidget(AH_plot, file = "AH_0314_0320_map.html", selfcontained = TRUE)
...
library(htmlwidgets)
saveWidget(RH_plot, file = "RH_0314_0320_map.html", selfcontained = TRUE)
...
AHRH1 <- ggplot(AHRH_poly) +
  ...
  theme_classic() +
  labs(fill = "Probability", color = "Presence") +
  ggtitle("March 14, 2026 to March 20, 2026: Atlantic Herring * (1-River Herring)") +
  coord_sf(crs = 32619) +
  annotation_north_arrow(location = "tl",
                         which_north = "true",
                         style = north_arrow_fancy_orienteering) +
...
library(htmlwidgets)
saveWidget(AHRH, file = "AHRH_0314_0320_map.html", selfcontained = TRUE)
...
AMRH1 <- ggplot(AMRH_poly) +
  ...
  theme_classic() +
  labs(fill = "Probability", color = "Presence") +
  ggtitle("March 14, 2026 to March 20, 2026: Atlantic Mackerel * (1-River Herring)") +
  coord_sf(crs = 32619) +
  annotation_north_arrow(location = "tl",
                         which_north = "true",
                         style = north_arrow_fancy_orienteering) +
...
library(htmlwidgets)
saveWidget(AMRH, file = "AMRH_0314_0320_map.html", selfcontained = TRUE)
...
pdf("forecast_0314_0320.pdf", width = 8, height = 6)
...
AM1_ci <- ggplot() +
  ...
  coord_sf(crs = 32619) +
  labs(fill = "CI width", color = "Presence") +
  ggtitle("March 14 - March 20: Atlantic Mackerel") 
#theme(legend.position = "none") +
# annotation_north_arrow(location = "tl",
#                        which_north = "true",
#                        style = north_arrow_fancy_orienteering) +
...
AH1_ci <- ggplot() +
  ...
  coord_sf(crs = 32619) +
  labs(fill = "CI width", color = "Presence") +
  ggtitle("March 14 - March 20: Atlantic Herring") 
...
RH1_ci <- ggplot() +
  ...
  coord_sf(crs = 32619) +
  labs(fill = "CI width", color = "Presence") +
  ggtitle("March 14 - March 20: River Herring") 
...
pdf("forecast_0314_0320_uncertainty.pdf", width = 8, height = 6)
...
# forecast for 03-21-2026 to 03-27-2026 ----
## forecast on 03-16-2026
## hindcast on 03-16 2006-2026

## ECMWF Real time ----
### perturbed with 100 members

# 03-21-2026
ECMWF_rt  <- rast("ECMWF_0321_rt.grib")
shape_rt <- st_transform(shape, crs(ECMWF_rt))
cropped_rt <- crop(ECMWF_rt, shape_rt)
masked_rt <- mask(cropped_rt, shape_rt)
...
rt_0321 <- rt %>% filter(forecast_time %in% c("2026-03-21"))


rt_mean21 <- rt_0321 %>% group_by(longitude, latitude) %>%
  summarise(temp_K = mean(temp_K))
...
# 03-22-2026
ECMWF_rt  <- rast("ECMWF_0322_rt.grib")
shape_rt <- st_transform(shape, crs(ECMWF_rt))
cropped_rt <- crop(ECMWF_rt, shape_rt)
masked_rt <- mask(cropped_rt, shape_rt)
...
rt_0322 <- rt %>% filter(forecast_time %in% c("2026-03-22"))


rt_mean22 <- rt_0322 %>% group_by(longitude, latitude) %>%
  summarise(temp_K = mean(temp_K))
...
# 03-23-2026
ECMWF_rt  <- rast("ECMWF_0323_rt.grib")
shape_rt <- st_transform(shape, crs(ECMWF_rt))
cropped_rt <- crop(ECMWF_rt, shape_rt)
masked_rt <- mask(cropped_rt, shape_rt)
...
rt_0323 <- rt %>% filter(forecast_time %in% c("2026-03-23"))


rt_mean23 <- rt_0323 %>% group_by(longitude, latitude) %>%
  summarise(temp_K = mean(temp_K))
...
# 03-24-2026
ECMWF_rt  <- rast("ECMWF_0324_rt.grib")
shape_rt <- st_transform(shape, crs(ECMWF_rt))
cropped_rt <- crop(ECMWF_rt, shape_rt)
masked_rt <- mask(cropped_rt, shape_rt)
...
rt_0324 <- rt %>% filter(forecast_time %in% c("2026-03-24"))


rt_mean24 <- rt_0324 %>% group_by(longitude, latitude) %>%
  summarise(temp_K = mean(temp_K))
...
# 03-25-2026
ECMWF_rt  <- rast("ECMWF_0325_rt.grib")
shape_rt <- st_transform(shape, crs(ECMWF_rt))
cropped_rt <- crop(ECMWF_rt, shape_rt)
masked_rt <- mask(cropped_rt, shape_rt)
...
rt_0325 <- rt %>% filter(forecast_time %in% c("2026-03-25"))


rt_mean25 <- rt_0325 %>% group_by(longitude, latitude) %>%
  summarise(temp_K = mean(temp_K))
...
# 03-26-2026
ECMWF_rt  <- rast("ECMWF_0326_rt.grib")
shape_rt <- st_transform(shape, crs(ECMWF_rt))
cropped_rt <- crop(ECMWF_rt, shape_rt)
masked_rt <- mask(cropped_rt, shape_rt)
...
rt_0326 <- rt %>% filter(forecast_time %in% c("2026-03-26"))


rt_mean26 <- rt_0326 %>% group_by(longitude, latitude) %>%
  summarise(temp_K = mean(temp_K))
...
# 03-27-2026
ECMWF_rt  <- rast("ECMWF_0327_rt.grib")
shape_rt <- st_transform(shape, crs(ECMWF_rt))
cropped_rt <- crop(ECMWF_rt, shape_rt)
masked_rt <- mask(cropped_rt, shape_rt)
...
rt_0327 <- rt %>% filter(forecast_time %in% c("2026-03-27"))


rt_mean27 <- rt_0327 %>% group_by(longitude, latitude) %>%
  summarise(temp_K = mean(temp_K))
...
ECMWF_hc<- rast("ECMWF_0321_0327_hc.grib")
...
all_dates <- do.call(
  ...
  lapply(years, function(y) {
    dates <- seq(
      from = as.Date(sprintf("%d-03-21", y)),
      to   = as.Date(sprintf("%d-03-27", y)),
      by = "day"
    )
...
SST_0321_0327 <- SST_mar %>% filter(day %in% c(21:27))


SST_0321 <- SST_0321_0327 %>% group_by(longitude, latitude) %>%
  summarise(temp_C = mean(temp_C))
...
ECMWF_df$date <- as.Date("2026-03-21")
...
library(htmlwidgets)
saveWidget(AM_plot, file = "AM_0321_0327_map.html", selfcontained = TRUE)
...
library(htmlwidgets)
saveWidget(AH_plot, file = "AH_0321_0327_map.html", selfcontained = TRUE)
...
library(htmlwidgets)
saveWidget(RH_plot, file = "RH_0321_0327_map.html", selfcontained = TRUE)
...
AHRH1 <- ggplot(AHRH_poly) +
  ...
  theme_classic() +
  labs(fill = "Probability", color = "Presence") +
  ggtitle("March 21, 2026 to March 27, 2026: Atlantic Herring * (1-River Herring)") +
  coord_sf(crs = 32619) +
  annotation_north_arrow(location = "tl",
                         which_north = "true",
                         style = north_arrow_fancy_orienteering) +
...
library(htmlwidgets)
saveWidget(AHRH, file = "AHRH_0321_0327_map.html", selfcontained = TRUE)
...
AMRH1 <- ggplot(AMRH_poly) +
  ...
  theme_classic() +
  labs(fill = "Probability", color = "Presence") +
  ggtitle("March 21, 2026 to March 27, 2026: Atlantic Mackerel * (1-River Herring)") +
  coord_sf(crs = 32619) +
  annotation_north_arrow(location = "tl",
                         which_north = "true",
                         style = north_arrow_fancy_orienteering) +
...
library(htmlwidgets)
saveWidget(AMRH, file = "AMRH_0321_0327_map.html", selfcontained = TRUE)
...
pdf("forecast_0321_0327.pdf", width = 8, height = 6)
...
AM1_ci <- ggplot() +
  ...
  coord_sf(crs = 32619) +
  labs(fill = "CI width", color = "Presence") +
  ggtitle("March 21 - March 27: Atlantic Mackerel") 
#theme(legend.position = "none") +
# annotation_north_arrow(location = "tl",
#                        which_north = "true",
#                        style = north_arrow_fancy_orienteering) +
...
AH1_ci <- ggplot() +
  ...
  coord_sf(crs = 32619) +
  labs(fill = "CI width", color = "Presence") +
  ggtitle("March 21 - March 27: Atlantic Herring") 
...
RH1_ci <- ggplot() +
  ...
  coord_sf(crs = 32619) +
  labs(fill = "CI width", color = "Presence") +
  ggtitle("March 21 - March 27: River Herring") 
...
pdf("forecast_0321_0327_uncertainty.pdf", width = 8, height = 6)
...
# forecast for 03-28-2026 to 04-03-2026 ----
## forecast on 03-23-2026
## hindcast on 03-23 2006-2026

## ECMWF Real time ----
### perturbed with 100 members

# 03-28-2026
ECMWF_rt  <- rast("ECMWF_0328_rt.grib")
shape_rt <- st_transform(shape, crs(ECMWF_rt))
cropped_rt <- crop(ECMWF_rt, shape_rt)
masked_rt <- mask(cropped_rt, shape_rt)
...
rt_0328 <- rt %>% filter(forecast_time %in% c("2026-03-28"))


rt_mean28 <- rt_0328 %>% group_by(longitude, latitude) %>%
  summarise(temp_K = mean(temp_K))
...
# 03-29-2026
ECMWF_rt  <- rast("ECMWF_0329_rt.grib")
shape_rt <- st_transform(shape, crs(ECMWF_rt))
cropped_rt <- crop(ECMWF_rt, shape_rt)
masked_rt <- mask(cropped_rt, shape_rt)
...
rt_0329 <- rt %>% filter(forecast_time %in% c("2026-03-29"))


rt_mean29 <- rt_0329 %>% group_by(longitude, latitude) %>%
  summarise(temp_K = mean(temp_K))
...
# 03-30-2026
ECMWF_rt  <- rast("ECMWF_0330_rt.grib")
shape_rt <- st_transform(shape, crs(ECMWF_rt))
cropped_rt <- crop(ECMWF_rt, shape_rt)
masked_rt <- mask(cropped_rt, shape_rt)
...
rt_0330 <- rt %>% filter(forecast_time %in% c("2026-03-30"))


rt_mean30 <- rt_0330 %>% group_by(longitude, latitude) %>%
  summarise(temp_K = mean(temp_K))
...
# 03-31-2026
ECMWF_rt  <- rast("ECMWF_0331_rt.grib")
shape_rt <- st_transform(shape, crs(ECMWF_rt))
cropped_rt <- crop(ECMWF_rt, shape_rt)
masked_rt <- mask(cropped_rt, shape_rt)
...
rt_0331 <- rt %>% filter(forecast_time %in% c("2026-03-31"))


rt_mean31 <- rt_0331 %>% group_by(longitude, latitude) %>%
  summarise(temp_K = mean(temp_K))
...
# 04-01-2026
ECMWF_rt  <- rast("ECMWF_0401_rt.grib")
shape_rt <- st_transform(shape, crs(ECMWF_rt))
cropped_rt <- crop(ECMWF_rt, shape_rt)
masked_rt <- mask(cropped_rt, shape_rt)
...
rt_0401 <- rt %>% filter(forecast_time %in% c("2026-04-01"))


rt_mean01 <- rt_0401 %>% group_by(longitude, latitude) %>%
  summarise(temp_K = mean(temp_K))
...
# 04-02-2026
ECMWF_rt  <- rast("ECMWF_0402_rt.grib")
shape_rt <- st_transform(shape, crs(ECMWF_rt))
cropped_rt <- crop(ECMWF_rt, shape_rt)
masked_rt <- mask(cropped_rt, shape_rt)
...
rt_0402 <- rt %>% filter(forecast_time %in% c("2026-04-02"))


rt_mean02 <- rt_0402 %>% group_by(longitude, latitude) %>%
  summarise(temp_K = mean(temp_K))
...
# 04-03-2026
ECMWF_rt  <- rast("ECMWF_0403_rt.grib")
shape_rt <- st_transform(shape, crs(ECMWF_rt))
cropped_rt <- crop(ECMWF_rt, shape_rt)
masked_rt <- mask(cropped_rt, shape_rt)
...
rt_0403 <- rt %>% filter(forecast_time %in% c("2026-04-03"))


rt_mean03 <- rt_0403 %>% group_by(longitude, latitude) %>%
  summarise(temp_K = mean(temp_K))
...
rt_df <- rbind.data.frame(rt_mean28, rt_mean29, rt_mean30, rt_mean31, rt_mean01,
                          rt_mean02, rt_mean03)
...
ECMWF_hc<- rast("ECMWF_0328_0403_hc.grib")
...
all_dates <- do.call(
  ...
  lapply(years, function(y) {
    dates <- seq(
      from = as.Date(sprintf("%d-03-28", y)),
      to   = as.Date(sprintf("%d-04-03", y)),
      by = "day"
    )
...
SST_0328_0331 <- SST_mar %>% filter(day %in% c(28:31))

SST_apr <- subset(SST_mean, month == 4)

SST_0401_0403 <- SST_apr %>% filter(day %in% c(01:03))

SST_0328_0403 <- rbind.data.frame(SST_0328_0331, SST_0401_0403)


SST_0328 <- SST_0328_0403 %>% group_by(longitude, latitude) %>%
  summarise(temp_C = mean(temp_C))
...
ECMWF_df$date <- as.Date("2026-03-28")
...
library(htmlwidgets)
saveWidget(AM_plot, file = "AM_0328_0403_map.html", selfcontained = TRUE)
...
library(htmlwidgets)
saveWidget(AH_plot, file = "AH_0328_0403_map.html", selfcontained = TRUE)
...
library(htmlwidgets)
saveWidget(RH_plot, file = "RH_0328_0403_map.html", selfcontained = TRUE)
...
AHRH1 <- ggplot(AHRH_poly) +
  ...
  theme_classic() +
  labs(fill = "Probability", color = "Presence") +
  ggtitle("March 28, 2026 to April 3, 2026: Atlantic Herring * (1-River Herring)") +
  coord_sf(crs = 32619) +
  annotation_north_arrow(location = "tl",
                         which_north = "true",
                         style = north_arrow_fancy_orienteering) +
...
library(htmlwidgets)
saveWidget(AHRH, file = "AHRH_0328_0403_map.html", selfcontained = TRUE)
...
AMRH1 <- ggplot(AMRH_poly) +
  ...
  theme_classic() +
  labs(fill = "Probability", color = "Presence") +
  ggtitle("March 28, 2026 to April 3, 2026: Atlantic Mackerel * (1-River Herring)") +
  coord_sf(crs = 32619) +
  annotation_north_arrow(location = "tl",
                         which_north = "true",
                         style = north_arrow_fancy_orienteering) +
...
library(htmlwidgets)
saveWidget(AMRH, file = "AMRH_0328_0403_map.html", selfcontained = TRUE)
...
pdf("forecast_0328_0401.pdf", width = 8, height = 6)
...
AM1_ci <- ggplot() +
  ...
  coord_sf(crs = 32619) +
  labs(fill = "CI width", color = "Presence") +
  ggtitle("March 28 - April 3: Atlantic Mackerel") 
#theme(legend.position = "none") +
# annotation_north_arrow(location = "tl",
#                        which_north = "true",
#                        style = north_arrow_fancy_orienteering) +
...
AH1_ci <- ggplot() +
  ...
  coord_sf(crs = 32619) +
  labs(fill = "CI width", color = "Presence") +
  ggtitle("March 28 - April 3: Atlantic Herring") 
...
RH1_ci <- ggplot() +
  ...
  coord_sf(crs = 32619) +
  labs(fill = "CI width", color = "Presence") +
  ggtitle("March 28 - April 3: River Herring") 
...
pdf("forecast_0328_0403_uncertainty.pdf", width = 8, height = 6)
...
# forecast for 04-4-2026 to 04-10-2026 ----
## forecast on 03-30-2026
## hindcast on 03-30 2006-2026

## ECMWF Real time ----
### perturbed with 100 members

# 04-04-2026
ECMWF_rt  <- rast("ECMWF_0404_rt.grib")
shape_rt <- st_transform(shape, crs(ECMWF_rt))
cropped_rt <- crop(ECMWF_rt, shape_rt)
masked_rt <- mask(cropped_rt, shape_rt)
...
rt_0404 <- rt %>% filter(forecast_time %in% c("2026-04-04"))


rt_mean04 <- rt_0404 %>% group_by(longitude, latitude) %>%
  summarise(temp_K = mean(temp_K))
...
# 04-05-2026
ECMWF_rt  <- rast("ECMWF_0405_rt.grib")
shape_rt <- st_transform(shape, crs(ECMWF_rt))
cropped_rt <- crop(ECMWF_rt, shape_rt)
masked_rt <- mask(cropped_rt, shape_rt)
...
rt_0405 <- rt %>% filter(forecast_time %in% c("2026-04-05"))


rt_mean05 <- rt_0405 %>% group_by(longitude, latitude) %>%
  summarise(temp_K = mean(temp_K))
...
# 04-06-2026
ECMWF_rt  <- rast("ECMWF_0406_rt.grib")
shape_rt <- st_transform(shape, crs(ECMWF_rt))
cropped_rt <- crop(ECMWF_rt, shape_rt)
masked_rt <- mask(cropped_rt, shape_rt)
...
rt_0406 <- rt %>% filter(forecast_time %in% c("2026-04-06"))


rt_mean06 <- rt_0406 %>% group_by(longitude, latitude) %>%
  summarise(temp_K = mean(temp_K))
...
# 04-07-2026
ECMWF_rt  <- rast("ECMWF_0407_rt.grib")
shape_rt <- st_transform(shape, crs(ECMWF_rt))
cropped_rt <- crop(ECMWF_rt, shape_rt)
masked_rt <- mask(cropped_rt, shape_rt)
...
rt_0407 <- rt %>% filter(forecast_time %in% c("2026-04-07"))


rt_mean07 <- rt_0407 %>% group_by(longitude, latitude) %>%
  summarise(temp_K = mean(temp_K))
...
# 04-08-2026
ECMWF_rt  <- rast("ECMWF_0408_rt.grib")
shape_rt <- st_transform(shape, crs(ECMWF_rt))
cropped_rt <- crop(ECMWF_rt, shape_rt)
masked_rt <- mask(cropped_rt, shape_rt)
...
rt_0408 <- rt %>% filter(forecast_time %in% c("2026-04-08"))


rt_mean08 <- rt_0408 %>% group_by(longitude, latitude) %>%
  summarise(temp_K = mean(temp_K))
...
# 04-09-2026
ECMWF_rt  <- rast("ECMWF_0409_rt.grib")
shape_rt <- st_transform(shape, crs(ECMWF_rt))
cropped_rt <- crop(ECMWF_rt, shape_rt)
masked_rt <- mask(cropped_rt, shape_rt)
...
rt_0409 <- rt %>% filter(forecast_time %in% c("2026-04-09"))


rt_mean09 <- rt_0409 %>% group_by(longitude, latitude) %>%
  summarise(temp_K = mean(temp_K))
...
# 04-10-2026
ECMWF_rt  <- rast("ECMWF_0410_rt.grib")
shape_rt <- st_transform(shape, crs(ECMWF_rt))
cropped_rt <- crop(ECMWF_rt, shape_rt)
masked_rt <- mask(cropped_rt, shape_rt)
...
rt_0410 <- rt %>% filter(forecast_time %in% c("2026-04-10"))


rt_mean10 <- rt_0410 %>% group_by(longitude, latitude) %>%
  summarise(temp_K = mean(temp_K))
...
rt_df <- rbind.data.frame(rt_mean04, rt_mean05, rt_mean06, rt_mean07, rt_mean08,
                          rt_mean09, rt_mean10)
...
ECMWF_hc<- rast("ECMWF_0404_0410_hc.grib")
...
all_dates <- do.call(
  ...
  lapply(years, function(y) {
    dates <- seq(
      from = as.Date(sprintf("%d-04-04", y)),
      to   = as.Date(sprintf("%d-04-10", y)),
      by = "day"
    )
...
SST_0404_0410 <- SST_apr %>% filter(day %in% c(04:10))


SST_0404 <- SST_0404_0410 %>% group_by(longitude, latitude) %>%
  summarise(temp_C = mean(temp_C))
...
ECMWF_df$date <- as.Date("2026-04-04")
...
library(htmlwidgets)
saveWidget(AM_plot, file = "AM_0404_0410_map.html", selfcontained = TRUE)
...
library(htmlwidgets)
saveWidget(AH_plot, file = "AH_0404_0410_map.html", selfcontained = TRUE)
...
library(htmlwidgets)
saveWidget(RH_plot, file = "RH_0404_0410_map.html", selfcontained = TRUE)
...
AHRH1 <- ggplot(AHRH_poly) +
  ...
  theme_classic() +
  labs(fill = "Probability", color = "Presence") +
  ggtitle("April 4, 2026 to April 10, 2026: Atlantic Herring * (1-River Herring)") +
  coord_sf(crs = 32619) +
  annotation_north_arrow(location = "tl",
                         which_north = "true",
                         style = north_arrow_fancy_orienteering) +
...
library(htmlwidgets)
saveWidget(AHRH, file = "AHRH_0404_0410_map.html", selfcontained = TRUE)
...
library(htmlwidgets)
saveWidget(AMRH, file = "AMRH_0404_0410_map.html", selfcontained = TRUE)
...
pdf("forecast_0404_0410.pdf", width = 8, height = 6)
...
AM1_ci <- ggplot() +
  ...
  coord_sf(crs = 32619) +
  labs(fill = "CI width", color = "Presence") +
  ggtitle("April 4 - April 10: Atlantic Mackerel") 
#theme(legend.position = "none") +
# annotation_north_arrow(location = "tl",
#                        which_north = "true",
#                        style = north_arrow_fancy_orienteering) +
...
AH1_ci <- ggplot() +
  ...
  coord_sf(crs = 32619) +
  labs(fill = "CI width", color = "Presence") +
  ggtitle("April 4 - April 10: Atlantic Herring") 
...
RH1_ci <- ggplot() +
  ...
  coord_sf(crs = 32619) +
  labs(fill = "CI width", color = "Presence") +
  ggtitle("April 4 - April 10: River Herring") 
...
pdf("forecast_0404_0410_uncertainty.pdf", width = 8, height = 6)
...
# forecast for 04-11-2026 to 04-17-2026 ----
## forecast on 04-06-2026
## hindcast on 04-06 2006-2026

## ECMWF Real time ----
### perturbed with 100 members

# 04-11-2026
ECMWF_rt  <- rast("ECMWF_0411_rt.grib")
shape_rt <- st_transform(shape, crs(ECMWF_rt))
cropped_rt <- crop(ECMWF_rt, shape_rt)
masked_rt <- mask(cropped_rt, shape_rt)
...
rt_0411 <- rt %>% filter(forecast_time %in% c("2026-04-11"))


rt_mean11 <- rt_0411 %>% group_by(longitude, latitude) %>%
  summarise(temp_K = mean(temp_K))
...
# 04-12-2026
ECMWF_rt  <- rast("ECMWF_0412_rt.grib")
shape_rt <- st_transform(shape, crs(ECMWF_rt))
cropped_rt <- crop(ECMWF_rt, shape_rt)
masked_rt <- mask(cropped_rt, shape_rt)
...
rt_0412 <- rt %>% filter(forecast_time %in% c("2026-04-12"))


rt_mean12 <- rt_0412 %>% group_by(longitude, latitude) %>%
  summarise(temp_K = mean(temp_K))
...
# 04-13-2026
ECMWF_rt  <- rast("ECMWF_0413_rt.grib")
shape_rt <- st_transform(shape, crs(ECMWF_rt))
cropped_rt <- crop(ECMWF_rt, shape_rt)
masked_rt <- mask(cropped_rt, shape_rt)
...
rt_0413 <- rt %>% filter(forecast_time %in% c("2026-04-13"))


rt_mean13 <- rt_0413 %>% group_by(longitude, latitude) %>%
  summarise(temp_K = mean(temp_K))
...
# 04-14-2026
ECMWF_rt  <- rast("ECMWF_0414_rt.grib")
shape_rt <- st_transform(shape, crs(ECMWF_rt))
cropped_rt <- crop(ECMWF_rt, shape_rt)
masked_rt <- mask(cropped_rt, shape_rt)
...
rt_0414 <- rt %>% filter(forecast_time %in% c("2026-04-14"))


rt_mean14 <- rt_0414 %>% group_by(longitude, latitude) %>%
  summarise(temp_K = mean(temp_K))
...
# 04-15-2026
ECMWF_rt  <- rast("ECMWF_0415_rt.grib")
shape_rt <- st_transform(shape, crs(ECMWF_rt))
cropped_rt <- crop(ECMWF_rt, shape_rt)
masked_rt <- mask(cropped_rt, shape_rt)
...
rt_0415 <- rt %>% filter(forecast_time %in% c("2026-04-15"))


rt_mean15 <- rt_0415 %>% group_by(longitude, latitude) %>%
  summarise(temp_K = mean(temp_K))
...
# 04-16-2026
ECMWF_rt  <- rast("ECMWF_0416_rt.grib")
shape_rt <- st_transform(shape, crs(ECMWF_rt))
cropped_rt <- crop(ECMWF_rt, shape_rt)
masked_rt <- mask(cropped_rt, shape_rt)
...
rt_0416 <- rt %>% filter(forecast_time %in% c("2026-04-16"))


rt_mean16 <- rt_0416 %>% group_by(longitude, latitude) %>%
  summarise(temp_K = mean(temp_K))
...
# 04-17-2026
ECMWF_rt  <- rast("ECMWF_0417_rt.grib")
shape_rt <- st_transform(shape, crs(ECMWF_rt))
cropped_rt <- crop(ECMWF_rt, shape_rt)
masked_rt <- mask(cropped_rt, shape_rt)
...
rt_0417 <- rt %>% filter(forecast_time %in% c("2026-04-17"))


rt_mean17 <- rt_0417 %>% group_by(longitude, latitude) %>%
  summarise(temp_K = mean(temp_K))
...
rt_df <- rbind.data.frame(rt_mean11, rt_mean12, rt_mean13, rt_mean14, rt_mean15,
                          rt_mean16, rt_mean17)
...
ECMWF_hc<- rast("ECMWF_0411_0417_hc.grib")
...
all_dates <- do.call(
  ...
  lapply(years, function(y) {
    dates <- seq(
      from = as.Date(sprintf("%d-04-11", y)),
      to   = as.Date(sprintf("%d-04-17", y)),
      by = "day"
    )
...
SST_0411_0417 <- SST_apr %>% filter(day %in% c(11:17))


SST_0411 <- SST_0411_0417 %>% group_by(longitude, latitude) %>%
  summarise(temp_C = mean(temp_C))
...
ECMWF_df$date <- as.Date("2026-04-11")
...
library(htmlwidgets)
saveWidget(AM_plot, file = "AM_0411_0417_map.html", selfcontained = TRUE)
...
library(htmlwidgets)
saveWidget(AH_plot, file = "AH_0411_0417_map.html", selfcontained = TRUE)
...
library(htmlwidgets)
saveWidget(RH_plot, file = "RH_0411_0417_map.html", selfcontained = TRUE)
...
AHRH1 <- ggplot(AHRH_poly) +
  ...
  theme_classic() +
  labs(fill = "Probability", color = "Presence") +
  ggtitle("April 11, 2026 to April 17, 2026: Atlantic Herring * (1-River Herring)") +
  coord_sf(crs = 32619) +
  annotation_north_arrow(location = "tl",
                         which_north = "true",
                         style = north_arrow_fancy_orienteering) +
...
library(htmlwidgets)
saveWidget(AHRH, file = "AHRH_0411_0417_map.html", selfcontained = TRUE)
...
AMRH1 <- ggplot(AMRH_poly) +
  ...
  theme_classic() +
  labs(fill = "Probability", color = "Presence") +
  ggtitle("April 11, 2026 to April 17, 2026: Atlantic Mackerel * (1-River Herring)") +
  coord_sf(crs = 32619) +
  annotation_north_arrow(location = "tl",
                         which_north = "true",
                         style = north_arrow_fancy_orienteering) +
...
library(htmlwidgets)
saveWidget(AMRH, file = "AMRH_0411_0417_map.html", selfcontained = TRUE)
...
pdf("forecast_0411_0417.pdf", width = 8, height = 6)
...
AM1_ci <- ggplot() +
  ...
  coord_sf(crs = 32619) +
  labs(fill = "CI width", color = "Presence") +
  ggtitle("April 11 - April 17: Atlantic Mackerel") 
#theme(legend.position = "none") +
# annotation_north_arrow(location = "tl",
#                        which_north = "true",
#                        style = north_arrow_fancy_orienteering) +
...
AH1_ci <- ggplot() +
  ...
  coord_sf(crs = 32619) +
  labs(fill = "CI width", color = "Presence") +
  ggtitle("April 11 - April 17: Atlantic Herring") 
...
RH1_ci <- ggplot() +
  ...
  coord_sf(crs = 32619) +
  labs(fill = "CI width", color = "Presence") +
  ggtitle("April 11 - April 17: River Herring") 
...
pdf("forecast_0411_0417_uncertainty.pdf", width = 8, height = 6)
...
# forecast for 04-18-2026 to 04-24-2026 ----
## forecast on 04-13-2026
## hindcast on 04-13 2006-2026

## ECMWF Real time ----
### perturbed with 100 members

# 04-18-2026
ECMWF_rt  <- rast("ECMWF_0418_rt.grib")
shape_rt <- st_transform(shape, crs(ECMWF_rt))
cropped_rt <- crop(ECMWF_rt, shape_rt)
masked_rt <- mask(cropped_rt, shape_rt)
...
rt_0418 <- rt %>% filter(forecast_time %in% c("2026-04-18"))


rt_mean18 <- rt_0418 %>% group_by(longitude, latitude) %>%
  summarise(temp_K = mean(temp_K))
...
# 04-19-2026
ECMWF_rt  <- rast("ECMWF_0419_rt.grib")
shape_rt <- st_transform(shape, crs(ECMWF_rt))
cropped_rt <- crop(ECMWF_rt, shape_rt)
masked_rt <- mask(cropped_rt, shape_rt)
...
rt_0419 <- rt %>% filter(forecast_time %in% c("2026-04-19"))


rt_mean19 <- rt_0419 %>% group_by(longitude, latitude) %>%
  summarise(temp_K = mean(temp_K))
...
# 04-20-2026
ECMWF_rt  <- rast("ECMWF_0420_rt.grib")
shape_rt <- st_transform(shape, crs(ECMWF_rt))
cropped_rt <- crop(ECMWF_rt, shape_rt)
masked_rt <- mask(cropped_rt, shape_rt)
...
rt_0420 <- rt %>% filter(forecast_time %in% c("2026-04-20"))


rt_mean20 <- rt_0420 %>% group_by(longitude, latitude) %>%
  summarise(temp_K = mean(temp_K))
...
# 04-21-2026
ECMWF_rt  <- rast("ECMWF_0421_rt.grib")
shape_rt <- st_transform(shape, crs(ECMWF_rt))
cropped_rt <- crop(ECMWF_rt, shape_rt)
masked_rt <- mask(cropped_rt, shape_rt)
...
rt_0421 <- rt %>% filter(forecast_time %in% c("2026-04-21"))


rt_mean21 <- rt_0421 %>% group_by(longitude, latitude) %>%
  summarise(temp_K = mean(temp_K))
...
# 04-22-2026
ECMWF_rt  <- rast("ECMWF_0422_rt.grib")
shape_rt <- st_transform(shape, crs(ECMWF_rt))
cropped_rt <- crop(ECMWF_rt, shape_rt)
masked_rt <- mask(cropped_rt, shape_rt)
...
rt_0422 <- rt %>% filter(forecast_time %in% c("2026-04-22"))


rt_mean22 <- rt_0422 %>% group_by(longitude, latitude) %>%
  summarise(temp_K = mean(temp_K))
...
# 04-23-2026
ECMWF_rt  <- rast("ECMWF_0423_rt.grib")
shape_rt <- st_transform(shape, crs(ECMWF_rt))
cropped_rt <- crop(ECMWF_rt, shape_rt)
masked_rt <- mask(cropped_rt, shape_rt)
...
rt_0423 <- rt %>% filter(forecast_time %in% c("2026-04-23"))


rt_mean23 <- rt_0423 %>% group_by(longitude, latitude) %>%
  summarise(temp_K = mean(temp_K))
...
# 04-24-2026
ECMWF_rt  <- rast("ECMWF_0424_rt.grib")
shape_rt <- st_transform(shape, crs(ECMWF_rt))
cropped_rt <- crop(ECMWF_rt, shape_rt)
masked_rt <- mask(cropped_rt, shape_rt)
...
rt_0424 <- rt %>% filter(forecast_time %in% c("2026-04-24"))


rt_mean24 <- rt_0424 %>% group_by(longitude, latitude) %>%
  summarise(temp_K = mean(temp_K))
...
rt_df <- rbind.data.frame(rt_mean18, rt_mean19, rt_mean20, rt_mean21, rt_mean22,
                          rt_mean23, rt_mean24)
...
ECMWF_hc<- rast("ECMWF_0418_0424_hc.grib")
...
all_dates <- do.call(
  ...
  lapply(years, function(y) {
    dates <- seq(
      from = as.Date(sprintf("%d-04-18", y)),
      to   = as.Date(sprintf("%d-04-24", y)),
      by = "day"
    )
...
SST_0418_0424 <- SST_apr %>% filter(day %in% c(18:24))


SST_0418 <- SST_0418_0424 %>% group_by(longitude, latitude) %>%
  summarise(temp_C = mean(temp_C))
...
ECMWF_df$date <- as.Date("2026-04-18")
...
library(htmlwidgets)
saveWidget(AM_plot, file = "AM_0418_0424_map.html", selfcontained = TRUE)
...
library(htmlwidgets)
saveWidget(AH_plot, file = "AH_0418_0424_map.html", selfcontained = TRUE)
...
library(htmlwidgets)
saveWidget(RH_plot, file = "RH_0418_0424_map.html", selfcontained = TRUE)
...
AHRH1 <- ggplot(AHRH_poly) +
  ...
  theme_classic() +
  labs(fill = "Probability", color = "Presence") +
  ggtitle("April 18, 2026 to April 24, 2026: Atlantic Herring * (1-River Herring)") +
  coord_sf(crs = 32619) +
  annotation_north_arrow(location = "tl",
                         which_north = "true",
                         style = north_arrow_fancy_orienteering) +
...
library(htmlwidgets)
saveWidget(AHRH, file = "AHRH_0418_0424_map.html", selfcontained = TRUE)
...
AMRH1 <- ggplot(AMRH_poly) +
  ...
  theme_classic() +
  labs(fill = "Probability", color = "Presence") +
  ggtitle("April 18, 2026 to April 24, 2026: Atlantic Mackerel * (1-River Herring)") +
  coord_sf(crs = 32619) +
  annotation_north_arrow(location = "tl",
                         which_north = "true",
                         style = north_arrow_fancy_orienteering) +
...
library(htmlwidgets)
saveWidget(AMRH, file = "AMRH_0418_0424_map.html", selfcontained = TRUE)
...
pdf("forecast_0418_0424.pdf", width = 8, height = 6)
...
AM1_ci <- ggplot() +
  ...
  coord_sf(crs = 32619) +
  labs(fill = "CI width", color = "Presence") +
  ggtitle("April 18 - April 24: Atlantic Mackerel") 
#theme(legend.position = "none") +
# annotation_north_arrow(location = "tl",
#                        which_north = "true",
#                        style = north_arrow_fancy_orienteering) +
...
AH1_ci <- ggplot() +
  ...
  coord_sf(crs = 32619) +
  labs(fill = "CI width", color = "Presence") +
  ggtitle("April 18 - April 24: Atlantic Herring") 
...
RH1_ci <- ggplot() +
  ...
  coord_sf(crs = 32619) +
  labs(fill = "CI width", color = "Presence") +
  ggtitle("April 18 - April 24: River Herring") 
...
pdf("forecast_0425_0501_uncertainty.pdf", width = 8, height = 6)
...
# forecast for 04-25-2026 to 05-01-2026 ----
## forecast on 04-20-2026
## hindcast on 04-20 2006-2026

## ECMWF Real time ----
### perturbed with 100 members

# 04-25-2026
ECMWF_rt  <- rast("ECMWF_0425_rt.grib")
shape_rt <- st_transform(shape, crs(ECMWF_rt))
cropped_rt <- crop(ECMWF_rt, shape_rt)
masked_rt <- mask(cropped_rt, shape_rt)
...
rt_0425 <- rt %>% filter(forecast_time %in% c("2026-04-25"))


rt_mean25 <- rt_0425 %>% group_by(longitude, latitude) %>%
  summarise(temp_K = mean(temp_K))
...
# 04-26-2026
ECMWF_rt  <- rast("ECMWF_0426_rt.grib")
shape_rt <- st_transform(shape, crs(ECMWF_rt))
cropped_rt <- crop(ECMWF_rt, shape_rt)
masked_rt <- mask(cropped_rt, shape_rt)
...
rt_0426 <- rt %>% filter(forecast_time %in% c("2026-04-26"))


rt_mean26 <- rt_0426 %>% group_by(longitude, latitude) %>%
  summarise(temp_K = mean(temp_K))
...
# 04-27-2026
ECMWF_rt  <- rast("ECMWF_0427_rt.grib")
shape_rt <- st_transform(shape, crs(ECMWF_rt))
cropped_rt <- crop(ECMWF_rt, shape_rt)
masked_rt <- mask(cropped_rt, shape_rt)
...
rt_0427 <- rt %>% filter(forecast_time %in% c("2026-04-27"))


rt_mean27 <- rt_0427 %>% group_by(longitude, latitude) %>%
  summarise(temp_K = mean(temp_K))
...
# 04-28-2026
ECMWF_rt  <- rast("ECMWF_0428_rt.grib")
shape_rt <- st_transform(shape, crs(ECMWF_rt))
cropped_rt <- crop(ECMWF_rt, shape_rt)
masked_rt <- mask(cropped_rt, shape_rt)
...
rt_0428 <- rt %>% filter(forecast_time %in% c("2026-04-28"))


rt_mean28 <- rt_0428 %>% group_by(longitude, latitude) %>%
  summarise(temp_K = mean(temp_K))
...
# 04-29-2026
ECMWF_rt  <- rast("ECMWF_0429_rt.grib")
shape_rt <- st_transform(shape, crs(ECMWF_rt))
cropped_rt <- crop(ECMWF_rt, shape_rt)
masked_rt <- mask(cropped_rt, shape_rt)
...
rt_0429 <- rt %>% filter(forecast_time %in% c("2026-04-29"))


rt_mean29 <- rt_0429 %>% group_by(longitude, latitude) %>%
  summarise(temp_K = mean(temp_K))
...
# 04-30-2026
ECMWF_rt  <- rast("ECMWF_0430_rt.grib")
shape_rt <- st_transform(shape, crs(ECMWF_rt))
cropped_rt <- crop(ECMWF_rt, shape_rt)
masked_rt <- mask(cropped_rt, shape_rt)
...
rt_0430 <- rt %>% filter(forecast_time %in% c("2026-04-30"))


rt_mean30 <- rt_0430 %>% group_by(longitude, latitude) %>%
  summarise(temp_K = mean(temp_K))
...
# 05-01-2026
ECMWF_rt  <- rast("ECMWF_0501_rt.grib")
shape_rt <- st_transform(shape, crs(ECMWF_rt))
cropped_rt <- crop(ECMWF_rt, shape_rt)
masked_rt <- mask(cropped_rt, shape_rt)
...
rt_0501 <- rt %>% filter(forecast_time %in% c("2026-05-01"))


rt_mean01 <- rt_0501 %>% group_by(longitude, latitude) %>%
  summarise(temp_K = mean(temp_K))
...
rt_df <- rbind.data.frame(rt_mean25, rt_mean26, rt_mean27, rt_mean28, rt_mean29,
                          rt_mean30, rt_mean01)
...
ECMWF_hc<- rast("ECMWF_0425_0501_hc.grib")
...
all_dates <- do.call(
  ...
  lapply(years, function(y) {
    dates <- seq(
      from = as.Date(sprintf("%d-04-25", y)),
      to   = as.Date(sprintf("%d-05-01", y)),
      by = "day"
    )
...
SST_0425_0430 <- SST_apr %>% filter(day %in% c(25:30))

SST_may <- subset(SST_mean, month == 5)

SST_0501 <- SST_may %>% filter(day %in% 1)

SST_0425_0501 <- rbind.data.frame(SST_0501, SST_0425_0430)

SST_0425 <- SST_0425_0501 %>% group_by(longitude, latitude) %>%
  summarise(temp_C = mean(temp_C))
...
ECMWF_df$date <- as.Date("2026-04-25")
...
library(htmlwidgets)
saveWidget(AM_plot, file = "AM_0425_0501_map.html", selfcontained = TRUE)
...
library(htmlwidgets)
saveWidget(AH_plot, file = "AH_0425_0501_map.html", selfcontained = TRUE)
...
library(htmlwidgets)
saveWidget(RH_plot, file = "RH_0425_0501_map.html", selfcontained = TRUE)
...
AHRH1 <- ggplot(AHRH_poly) +
  ...
  theme_classic() +
  labs(fill = "Probability", color = "Presence") +
  ggtitle("April 25, 2026 to May 1, 2026: Atlantic Herring * (1-River Herring)") +
  coord_sf(crs = 32619) +
  annotation_north_arrow(location = "tl",
                         which_north = "true",
                         style = north_arrow_fancy_orienteering) +
...
library(htmlwidgets)
saveWidget(AHRH, file = "AHRH_0425_0501_map.html", selfcontained = TRUE)
...
AMRH1 <- ggplot(AMRH_poly) +
  ...
  theme_classic() +
  labs(fill = "Probability", color = "Presence") +
  ggtitle("April 25, 2026 to May 1, 2026: Atlantic Mackerel * (1-River Herring)") +
  coord_sf(crs = 32619) +
  annotation_north_arrow(location = "tl",
                         which_north = "true",
                         style = north_arrow_fancy_orienteering) +
...
library(htmlwidgets)
saveWidget(AMRH, file = "AMRH_0425_0501_map.html", selfcontained = TRUE)
...
pdf("forecast_0425_0501.pdf", width = 8, height = 6)
...
AM1_ci <- ggplot() +
  ...
  coord_sf(crs = 32619) +
  labs(fill = "CI width", color = "Presence") +
  ggtitle("April 25 - May 1: Atlantic Mackerel") 
#theme(legend.position = "none") +
# annotation_north_arrow(location = "tl",
#                        which_north = "true",
#                        style = north_arrow_fancy_orienteering) +
...
AH1_ci <- ggplot() +
  ...
  coord_sf(crs = 32619) +
  labs(fill = "CI width", color = "Presence") +
  ggtitle("April 25 - May 1: Atlantic Herring") 
...
RH1_ci <- ggplot() +
  ...
  coord_sf(crs = 32619) +
  labs(fill = "CI width", color = "Presence") +
  ggtitle("April 25 - May 1: River Herring") 
